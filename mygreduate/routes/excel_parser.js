...
//定义一个函数来生成Excel表格
function make_excel_by_ob(){
    //先获取，生成Excel表格的对像，以确定该对象的结构

    //测试，刚解析出的对象，是否可以用来做生成Excel表的对象
     var list = xlsx.parse("F:/learn/123.xlsx");
    ...
    fs.writeFileSync('F:/learn/user.xlsx', file, 'binary');
